...
import static org.buaa.rag.common.enums.OfflineErrorCodeEnum.DOCUMENT_MIME_FAILED;
...
public class FileTypeValidate {
    ...
    public static InspectedFile inspectLocal(MultipartFile file) {
        ...
        validate(fileName, mimeType, fileHeader);
    ...
    public static InspectedFile inspectRemote(InputStreamSource source,
        ...
        byte[] fileHeader = readFileHeader(source);
        validate(resolvedFileName, mimeType, fileHeader);
